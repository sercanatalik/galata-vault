...
//! binary may supply its own through [`crate::ContextBuilder::key_store`].
//!
...
use galata_vault::{KeyName, KeyStore, StoreError};
use serde::{Deserialize, Serialize};
use zeroize::Zeroizing;

use crate::branding::Branding;
use crate::config::Home;
use crate::context::{Output, say};
use crate::fsutil::{require_private, write_private};
