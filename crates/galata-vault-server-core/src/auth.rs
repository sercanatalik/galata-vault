...
//! digest, vault, time, nonce and preconditions; see `galata_vault_proto::sig`).
//!
...
use galata_vault_proto::api::{ErrorCode, Scope};
use galata_vault_proto::audit::{Actor, AuditAction, AuditEvent, AuditResult};
use galata_vault_proto::descriptor::Descriptor;
use galata_vault_proto::ids::{Key32, NameHmac, Sig64, TokenId};
use galata_vault_proto::integrity::verify_ed25519;
use galata_vault_proto::sig::{MAX_SKEW_SECS, SigActor, SigParams, SignedRequest};
use galata_vault_store::{Ctx, SpentKind, TokenRow, VaultRow};

use crate::error::CoreError;
use crate::{CanonicalRequest, Core};
