...
//! (`galata_vault_server_core::data_dir`), and it has one opener at a time: a second
...
use galata_vault_server_core::data_dir::{DATABASE, JOURNAL_ROOT};

use crate::config::{JournalConfig, ServerConfig};
