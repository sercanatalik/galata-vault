...
use galata_vault_keys::{FullBundle, NodeKey, TokenKeys, seal_for_scope, seal_owner_bundle};
use galata_vault_proto::api::{DescriptorList, Scope, VaultStatus};
use galata_vault_proto::audit::{AuditAction, AuditResult};
use galata_vault_proto::children::{ChildEntry, ChildMode, ChildrenBlob, ChildrenRecord};
use galata_vault_proto::ids::{Hash32, VaultId};
...
mod down {
    use galata_vault_server::journal::Journal;
    use galata_vault_store::JournalRecord;
