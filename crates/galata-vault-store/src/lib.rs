...
use galata_vault_proto::api::{Limits, RotationRequest, Scope, SignedBundle};
use galata_vault_proto::audit::{Actor, AuditEvent, AuditRow, ChainHead};
use galata_vault_proto::children::ChildrenBlob;
use galata_vault_proto::descriptor::SignedDescriptor;
use galata_vault_proto::ids::{Hash32, Key32, NameHmac, Sig64, TokenId, VaultId};
...
impl RecordKind {
    ...
    pub fn wire(self) -> galata_vault_proto::record::RecordKind {
        match self {
            RecordKind::Secret => galata_vault_proto::record::RecordKind::Secret,
            RecordKind::Config => galata_vault_proto::record::RecordKind::Config,
        }
    }
}
