...
use crate::proto::api::{OWNER_SCOPE_CODE, OWNER_TOKEN_ID, bundle_signing_input};
use crate::proto::children::{ChildrenBlob, ChildrenRecord, children_signing_input};
use crate::proto::descriptor::{Descriptor, SignedDescriptor};
use crate::proto::frame::label;
use crate::proto::ids::{B64, Key32, Sig64, TokenId, VaultId};
use crate::proto::sig::{SigActor, SigParams, SignedRequest, signing_input};
use ed25519_dalek::{Signer, SigningKey};
use zeroize::Zeroizing;

use crate::keys::KeyError;
use crate::keys::bundle::{Binding, FullBundle, open_bundle, open_child_key, seal_bytes};
...
impl OwnerKeys {
    ...
    pub fn open_own_bundle(
        &self,
        signed: &crate::proto::api::SignedBundle,
        generation: u32,
...
mod tests {
    ...
    fn request_signatures_verify_against_the_canonical_input() {
        ...
        assert!(
            crate::proto::integrity::verify_ed25519(
                &owner.sign_pub(),
