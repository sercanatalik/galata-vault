...
use crate::proto::api::{Scope, SignedBundle, report_signing_input};
use crate::proto::children::{ChildrenBlob, ChildrenError, ChildrenRecord, children_signing_input};
use crate::proto::descriptor::{Descriptor, SignedDescriptor};
use crate::proto::frame::label;
...
use crate::proto::record::{RecordContext, RecordKind};
use crate::proto::sig::{SigActor, SigError, SigParams, SignedRequest, signing_input};
use crate::proto::vectors::{
...
use crate::keys::bundle::Bundle;
use crate::keys::kdf::{derive32, info};
use crate::keys::name_key::{NameContext, NameKey};
use crate::keys::node::NodeKey;
use crate::keys::token::TokenKeys;
use crate::keys::writer::WriterKey;
...
fn signatures(op: &str, i: Inputs<'_>) -> Step<Outcome> {
    Ok(match op {
        ...
        "bundle" => {
            ...
            signed(
                crate::proto::api::bundle_signing_input(
                    &owner.vault_id(),
                    &token,
                    scope,
                    generation,
...
fn children(op: &str, i: Inputs<'_>) -> Step<Outcome> {
    match op {
        "encode" => {
            let doc = json!({ "v": crate::proto::children::CHILDREN_RECORD_VERSION, "children": i.get("children")? });
