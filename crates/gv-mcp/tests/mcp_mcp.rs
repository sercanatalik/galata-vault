...
use galata_vault::proto::api::{CreateVaultRequest, RegisterTokenRequest, Scope};
...
use galata_vault::proto::sig::{SigActor, SigParams, SignedRequest};
...
/// client waits up to `galata_vault::mcp::env::TIMEOUT` (60s) for each. A
