...
TABLE: list[tuple[str | None, list[tuple[str, str]]]] = [
    ...
    ("Crates", [
        ...
        ("galata_vault::cli", "crates/galata_vault::cli/README.md"),
        ("galata_vault::server", "crates/galata_vault::server/README.md"),
        ("galata_vault::mcp", "crates/galata_vault::mcp/README.md"),
        ("galata-vault on PyPI", "crates/gv-py/README.md"),
        ("galata_vault::proto", "crates/galata_vault::proto/README.md"),
        ("galata_vault::keys", "crates/galata_vault::keys/README.md"),
        ("galata_vault::seal", "crates/galata_vault::seal/README.md"),
        ("galata_vault::client", "crates/galata_vault::client/README.md"),
        ("galata_vault::backend", "crates/galata_vault::backend/README.md"),
        ("galata_vault::server_core", "crates/galata_vault::server_core/README.md"),
    ]),
    ("Project", [
